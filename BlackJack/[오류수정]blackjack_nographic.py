...
def blackjack():
  ...
  data=deck.draw()
  player.append(data)
  print("You are dealt {}".format(data))
  ...
  if(hand_value(dealer)<=17):
    ...
    sum = hand_value(dealer)
    print("The dealer's total is {}".format(sum))
  ...
  playerSum=hand_value(player)
  dealerSum=hand_value(dealer)
  print("Your total is {}".format(playerSum))
  print("The dealer's total is {}".format(dealerSum))
  if(dealerSum>21):
